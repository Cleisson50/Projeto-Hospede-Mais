...
export default function NewUser({ navigation }) {
    ...
    return (
        <KeyboardAvoidingView behavior="padding" style={styles.container}>
            ...
            <TextInput style={styles.input} autoComplete="tel-country-code" maxLength={18} keyboardType="phone-pad" placeholder="Insira seu número" type="text" onChangeText={(text) => setTelefone(text)} value={telefone} />
